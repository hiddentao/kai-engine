...
/**
 * Provides named constants which can be used to refer to components of vectors.
 */
public interface VectorComponents
{
	public static final int _X_ = 0;
	public static final int _Y_ = 1;
	public static final int _Z_ = 2;
	public static final int _W_ = 3;
}
